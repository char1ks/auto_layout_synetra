...
class ScoreCalculator:
    ...
    def __init__(self, detector, params: Dict[str, Any] | None = None):
        ...
        self.min_pos_score: float = float(params.get('min_pos_score', 0.58))
        self.decision_threshold: float = float(params.get('decision_threshold', 0.06))
        self.class_separation: float = float(params.get('class_separation', 0.05))
        self.neg_cap: float = float(params.get('neg_cap', 0.95))
        self.topk: int = int(params.get('topk', 3))

        self.consensus_k: int = int(params.get('consensus_k', 1))
        self.consensus_thr: float = float(params.get('consensus_thr', 0.58))

        self.adaptive_ratio: float = float(params.get('adaptive_ratio', 0.95))
        ...
        self.margin: float = float(params.get('score_margin', -0.10))
